...
const SwarmMonitor = ({ 
  ...
  const notes = summaryNotes.length > 0 ? summaryNotes : defaultNotes;

  return (
    <div className="w-full font-mono select-none py-10">
      {/* Top Header Section */}
      <div className="flex items-center gap-4 mb-8 opacity-40">
        <div className="h-px flex-1 bg-gradient-to-r from-transparent to-gray-500/30" />
        <span className="text-[10px] tracking-[0.5em] font-black uppercase whitespace-nowrap text-gray-400">
          Distributed Infrastructure
        </span>
        <div className="h-px flex-1 bg-gradient-to-l from-transparent to-gray-500/30" />
      </div>
      ...
      <div className="flex flex-col xl:flex-row items-center justify-center gap-8 px-6">
        ...
        <motion.div 
          ...
          className="w-full max-w-md bg-[var(--irc-sidebar)] border border-[var(--irc-border)] rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden shadow-2xl"
        >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[var(--irc-bg)] border border-[var(--irc-border)] p-4 rounded-2xl group hover:border-[var(--irc-accent)] transition-all">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-black text-[var(--irc-text)] italic tabular-nums">{swarmSize}</span>
              ...
              <div className="bg-[var(--irc-bg)] border border-[var(--irc-border)] p-4 rounded-2xl group hover:border-[var(--irc-accent)] transition-all">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-black text-[var(--irc-text)] italic tabular-nums">{activeTasks}</span>
              ...
              {[
                ...
                return (
                  <div key={i} className="flex flex-col items-center gap-2 group cursor-help">
                    <Icon size={13} className="text-gray-600 group-hover:text-blue-400 transition-colors" />
        ...
        {[
          ...
          return (
            <div key={idx} className="flex items-center gap-2 group grayscale hover:grayscale-0 transition-all duration-500">
              <Icon size={12} className="group-hover:text-blue-400" />
